    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <h3 class="font-semibold mb-2">Find Services</h3>
                <p class="text-gray-600">Browse from thousands of services</p>
            </div>
            <div class="text-center">
                <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p class="text-gray-600">Hire and collaborate with freelancers</p>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-primary text-white py-16">
    <div class="container mx-auto px-4 text-center">
        ...
        <p class="text-xl mb-8">Join thousands of satisfied clients today</p>
